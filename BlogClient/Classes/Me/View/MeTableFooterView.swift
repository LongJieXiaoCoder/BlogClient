...
class MeTableFooterView: UIBaseView, InitViewProtocol {
    ...
    func initView() {
        logoutButton = UIButton.lc.initButton(frame: CGRect.zero, title: R.string.localizable.logout(preferredLanguages: kAppLanguage), font: R.font.stHeitiSCMedium(size: 14), titleColor: R.color.red_F1435A())
        logoutButton.addTarget(self, action: #selector(logoutAction), for: .touchUpInside)
        logoutButton.lc.addBorderAndCorner(borderWidth: 0.5, borderColor: R.color.black_ECECEC(), radius: 25)
